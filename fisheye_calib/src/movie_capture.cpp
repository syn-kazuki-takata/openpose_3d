...
int main(int argh, char* argv[])
{
    ...
    //出力動画ファイルの指定
    cv::VideoWriter writer1(argv[3], cv::VideoWriter::fourcc('M','J','P','G'), camera1.get(cv::CAP_PROP_FPS), cv::Size((int)camera1.get(cv::CAP_PROP_FRAME_WIDTH), (int)camera1.get(cv::CAP_PROP_FRAME_HEIGHT)));
